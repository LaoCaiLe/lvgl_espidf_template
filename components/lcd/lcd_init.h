...
#define LCD_BLK_Set()  gpio_set_level(LCD_BLK_PIN,0)
...
#define LCD_MOSI_Clr() gpio_set_level(LCD_MOSI_PIN,0)//SDA=MOSI
#define LCD_MOSI_Set() gpio_set_level(LCD_MOSI_PIN,1)

#define LCD_SCLK_Clr() gpio_set_level(LCD_SCLK_PIN,0)//SCL=SCLK
#define LCD_SCLK_Set() gpio_set_level(LCD_SCLK_PIN,1)

#define LCD_CS_Clr()   gpio_set_level(LCD_CS_PIN,0)//CS
#define LCD_CS_Set()   gpio_set_level(LCD_CS_PIN,1)

/*
LEDA GND RES RS SDA SCL VCC CS
